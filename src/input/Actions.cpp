...
namespace vtplayer
{
    namespace
    {
        std::unordered_map<std::string, Action> const & tokenTable()
        {
            static std::unordered_map<std::string, Action> const table = {
                ...
                { "queue-toggle", Action::ToggleRightPanel },
                ...
                { "left-streaming", Action::LeftModeStreaming },
                { "append", Action::Append },
                { "add-playlist", Action::AddToPlaylist },
                { "tag-edit", Action::TagEdit },
                { "tag-edit-immediate", Action::TagEditImmediate },
                { "file-rename", Action::RenameFile },
                ...
                { "select-up", Action::ExtendSelectionUp },
                { "select-down", Action::ExtendSelectionDown },
    ...
    std::vector<HelpEntry> const & actionHelpEntries()
    {
        ...
        static std::vector<HelpEntry> const entries = {
            ...
            { Action::ToggleRightPanel, C::Panels, "Toggle play queue panel" },
            ...
            { Action::LeftModeStreaming, C::Panels, "Left panel: Streaming" },
            ...
            { Action::TagEditImmediate, C::Commands, "Edit tags now" },
            { Action::RenameFile, C::Commands, "Rename selected file" },
            { Action::Remove, C::Commands, "Remove item(s) from the queue" },
            { Action::ExtendSelectionUp, C::Commands, "Extend selection up" },
            { Action::ExtendSelectionDown, C::Commands, "Extend selection down" },
